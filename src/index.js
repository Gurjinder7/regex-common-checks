 ...
 */
export const containAnyDigits = (pattern) => {
    const checker = /[\d]/g
 ...
 */
export const containsThisSymbol = (searchString, pattern) => {
 ...
 */
export const firstSymbolMatchIndex = (searchString, pattern) => {
    const checker = new RegExp(`[\\${pattern}]`);
 ...
 */
export const containsThisOrThatSymbol = (searchString, symbol1, symbol2) => {
 ...
 */
export const startsWithADigitAndEndsWithALetter = (pattern) => {
 ...
 */
export const startsWithALetterAndEndsWithADigit = (pattern) => {
 ...
 */
export const startsWithADigitAndEndsWithADigit = (pattern) => {
 ...
 */
export const startsWithALetterAndEndsWithALetter = (pattern) => {
