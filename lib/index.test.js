...
test("checks if pattern contains any digit", () => {
  expect((0, _index.containAnyDigits)("123asdasd#$")).toBeTruthy();
  expect((0, _index.containAnyDigits)("asdasdkjh*(asd")).toBeFalsy();
  expect((0, _index.containAnyDigits)("!@#asdasd")).toBeFalsy();
});
...
test("checks if pattern contains No digit", () => {
  expect((0, _index.containOnlyLetters)("asdasd")).toBeTruthy();
  expect((0, _index.containOnlyLetters)("as123dasd")).toBeFalsy();
  expect((0, _index.containOnlyLetters)("as$dasd")).toBeFalsy();
});
